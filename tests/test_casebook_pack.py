"""Regression checks for the nexus-store-btree-kit casebook."""
...
from casebook.harness import assert_expected, nexus_store_btree_kit_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(nexus_store_btree_kit_summary(), assert_expected())
